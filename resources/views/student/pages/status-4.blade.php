                ...
                <div class="col-md-12">
                    <div class="alert alert-success m-1">
                        <p class="p-1 text-justify">
                            اطلاعات وارد شده را با دقت مطالعه  و درصورت نیاز ویرایش نمایید سپس دکمه بعدی را انتخاب کنید ، لازم به ذکر میباشد صحت اطلاعات شما در این مرحله تایید نهایی میشوند .
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-6 padding-top-15">
                        ...
                        <div class="col-md-12 col-sm-10">
                            <input type="number" pattern="[0-9]{10}" name="meli_number" id="meli_number"
                                   value="{{$user->student->meli_number}}" minlength="10"  maxlength="10"
                    ...
                    <div class="col-md-6 padding-top-15">
                        ...
                        <div class="col-md-12 col-sm-10">
                            <input type="tel" placeholder="{{__('web/public.example')}} : 09125555555"
                                   ...
                                   value="{{$user->student->phone_f}}" minlength="11"  maxlength="11"
                    ...
                    <div class="col-md-6 padding-top-15">
                        ...
                        <div class="col-md-12 col-sm-10">
                            <input type="tel" placeholder="{{__('web/public.example')}} : 09125555555"
                                   ...
                                   value="{{$user->student->phone_m}}" minlength="11"  maxlength="11"
                    ...
                    <div class="col-md-6 padding-top-15">
                        ...
                        <div class="col-md-12 col-sm-10">
                            <input type="tel" placeholder="{{__('web/public.example')}} : 09125555555"
                                   ...
                                   value="{{$user->student->phone_1}}" minlength="11"  maxlength="11"
                    ...
                    <div class="col-md-6 padding-top-15">
                        ...
                        <div class="col-md-12 col-sm-10">
                            <input type="tel" placeholder="{{__('web/public.example')}} : 09125555555"
                                   ...
                                   value="{{$user->student->phone_2}}" minlength="11"  maxlength="11"
