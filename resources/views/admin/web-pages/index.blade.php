            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-sm-12">
                        <h2>{{__('admin/public.web_pages_list')}}</h2>
                    </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="body">
                            {{--<a href="{{ route('webPages.create') }}" id="addToTable" class="btn btn-primary m-b-15" type="button">--}}
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover js-basic-example dataTable table-custom">
                                    ...
                                    <tbody>
                                    @foreach($allWebPages as $webPages)
                                        <tr class="gradeA">
                                            <td>{{$webPages->id}}</td>
                                            ...
                                            <td class="actions">
                                                ...
                                                <form action="{{ route('webPages.destroy', $webPages->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a href="{{ route('webPages.show',$webPages->id) }}" class="btn btn-sm btn-icon btn-pure btn-default on-default m-r-5 button-show"
