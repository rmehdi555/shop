                    ...
                    <div class="card">
                        ...
                        <div class="body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description_{{$kay}}" id="ckeditor" class="form-control" rows="5" cols="30" required>{{\App\Providers\MyProvider::_text($menuCategories->description,$kay)}}</textarea>
