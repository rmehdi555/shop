                        ...
                        <div class="body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title_{{$kay}}" class="form-control"
                                       value="{{\App\Providers\MyProvider::_text($newsCategories->title,$kay)}}"
                                       required>
                            </div>
                            <?php
                            }
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description_{{$kay}}" id="ckeditor" class="form-control" rows="5"
                                          cols="30"
                                          required>{{\App\Providers\MyProvider::_text($newsCategories->description,$kay)}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="body_{{$kay}}" class="form-control ckeditor" rows="5" cols="30"
                                          required>{{\App\Providers\MyProvider::_text($newsCategories->body,$kay)}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tags" class="form-control" value="{{$newsCategories->tags}}"
                                       required>
                            </div>
                            <div class="form-group">
                                <label>{{__('admin/public.priority')}} :</label>
                                <input type="number" name="priority" class="form-control"
                                       value="{{$newsCategories->priority}}" required>
                            </div>
                            <div class="form-group">
                                <label>{{__('admin/public.icon')}} :</label>
                                <input type="text" name="icon" class="form-control" value="{{$newsCategories->icon}}"
                                       required>
                            </div>
