            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="body">
                            {{--<a href="{{ route('newsCategories.create') }}" id="addToTable" class="btn btn-primary m-b-15" type="button">--}}
                                {{--<i class="icon wb-plus" aria-hidden="true"></i> {{__('admin/public.news_add')}}--}}
                            {{--</a>--}}
