                        ...
                        <div class="body">
                            <form id="basic-form" action="{{ route('newsCategories.update',$newsCategories->id) }}" method="post" enctype="multipart/form-data" novalidate>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="seo_title" class="form-control" value="{{$newsCategories->seo_title}}" required>
                                </div>
                                <div class="form-group">
                                    <label>{{__('admin/public.seo_description')}} :</label>
                                    <textarea name="seo_description" id="seo_description" class="form-control" rows="5" cols="30" required>{{$newsCategories->seo_description}}</textarea>
                                ...
                                <div class="form-group col-lg-4 col-md-12">
                                    ...
                                    <div class="multiselect_div">
                                        <select id="single-selection" name="seo_follow" class="multiselect multiselect-custom" >
                                            ...
                                            <option value="1" {{$newsCategories->seo_follow?"selected":""}}>{{__('admin/public.seo_follow_follow')}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group col-lg-4 col-md-12">
                                    ...
                                    <div class="multiselect_div">
                                        <select id="single-selection" name="seo_index" class="multiselect multiselect-custom" >
                                            ...
                                            <option value="1" {{$newsCategories->seo_index?"selected":""}}>{{__('admin/public.seo_index_index')}}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="seo_canonical" id="seo_canonical" class="form-control" rows="5"
                                              cols="30" >{{$newsCategories->seo_canonical}}</textarea>
