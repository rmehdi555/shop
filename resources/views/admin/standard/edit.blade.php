            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="basic-form" action="{{ route('standard.update',$standard->id) }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title_{{$kay}}" class="form-control"
                                           value="{{\App\Providers\MyProvider::_text($standard->title,$kay)}}" required>
                                </div>
                            <?php
                                }
                                ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="body_{{$kay}}" class="form-control ckeditor" rows="5" cols="30"
                                              required>{{\App\Providers\MyProvider::_text($standard->body,$kay)}}</textarea>
                                    ...
                                    <div class="multiselect_div">
                                        <select id="single-selection" name="product_categories_id"
                                            ...
                                            @foreach($productCategories as $category)
                                                <option value="{{$category->id}}" {{($standard->product_categories_id==$category->id)?"selected":""}}>{{\App\Providers\MyProvider::_text($category->title)}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="media">
                                    <img class="media-object " src="{{$standard->images["thumb"]??null}}" alt="">
                                </div>
                                <div class="form-group">
                                    <label>{{__('admin/public.priority')}} :</label>
                                    <input type="number" name="priority" class="form-control"
                                           value="{{$standard->priority}}" required>
                                </div>
                                ...
                                <div class="form-group col-lg-4 col-md-12">
                                    ...
                                    <div class="multiselect_div">
                                        <select id="single-selection" name="status"
                                            ...
                                            <option value="1" {{$standard->status?"selected":""}}>{{__('admin/public.active')}}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="seo_title" class="form-control" value="{{$standard->seo_title}}" required>
                                </div>
                                <div class="form-group">
                                    <label>{{__('admin/public.seo_description')}} :</label>
                                    <textarea name="seo_description" id="seo_description" class="form-control" rows="5" cols="30" required>{{$standard->seo_description}}</textarea>
                                ...
                                <div class="form-group col-lg-4 col-md-12">
                                    ...
                                    <div class="multiselect_div">
                                        <select id="single-selection" name="seo_follow" class="multiselect multiselect-custom" >
                                            ...
                                            <option value="1" {{$standard->seo_follow?"selected":""}}>{{__('admin/public.seo_follow_follow')}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group col-lg-4 col-md-12">
                                    ...
                                    <div class="multiselect_div">
                                        <select id="single-selection" name="seo_index" class="multiselect multiselect-custom" >
                                            ...
                                            <option value="1" {{$standard->seo_index?"selected":""}}>{{__('admin/public.seo_index_index')}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
