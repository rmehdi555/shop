<div id="rightsidebar" class="right-sidebar">
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane animated fadeIn in active" id="skins" aria-expanded="true">
            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: calc(100vh - 60px);"><div class="sidebar-scroll" style="overflow: hidden; width: auto; height: calc(100vh - 60px);">
                    <div class="card">
                        <div class="header">
                ...
                </div><div class="slimScrollBar" style="background: rgb(239, 239, 239); width: 2px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 3px; z-index: 99; right: 1px; height: 438.496px;"></div><div class="slimScrollRail" style="width: 2px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div></div>
        </div>
        <div role="tabpanel" class="tab-pane animated fadeIn" id="contact" aria-expanded="false">
            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: calc(100vh - 60px);"><div class="sidebar-scroll" style="overflow: hidden; width: auto; height: calc(100vh - 60px);">
                ...
                </div><div class="slimScrollBar" style="background: rgb(239, 239, 239); width: 2px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 3px; z-index: 99; right: 1px;"></div><div class="slimScrollRail" style="width: 2px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div></div>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <ul class="list-unstyled basic-list">
                                ...
                                <li><i class="icon-screen-tablet m-r-5"></i> Support Tickets<span class="badge-success badge">9</span></li>
