            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="basic-form" action="{{ route('productCategories.update',$productCategories->id) }}" method="post" enctype="multipart/form-data" novalidate>
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description_{{$kay}}" id="description_{{$kay}}" class="form-control" rows="5" cols="30" required>{{\App\Providers\MyProvider::_text($productCategories->description,$kay)}}</textarea>
                                    ...
                                    <div class="multiselect_div">
                                        <select id="single-selection" name="parent_id" class="multiselect multiselect-custom" >
                                            ...
                                            @foreach($categories as $category)
                                                <option value="{{$category->id}}" {{$category->id==$productCategories->parent_id?"selected":""}}>{{\App\Providers\MyProvider::_text($category->title)}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="seo_canonical" id="seo_canonical" class="form-control" rows="5"
                                              cols="30" >{{$productCategories->seo_canonical}}</textarea>
