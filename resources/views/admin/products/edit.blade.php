            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="basic-form" action="{{ route('products.update',$products->id) }}" method="POST" enctype="multipart/form-data" novalidate>
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description_{{$kay}}" id="description_{{$kay}}" class="form-control" rows="5" cols="30" required>{{\App\Providers\MyProvider::_text($products->description,$kay)}}</textarea>
