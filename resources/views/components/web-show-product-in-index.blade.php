<div class="section-title">
    <span>
        <a href="{{ route('web.show.category',$category->slug) }}">{{\App\Providers\MyProvider::_text($category->title)}}</a>
    </span>
</div>
<div class="points-table ">
    ...
    <a href="{{ route('web.show.category',$category->slug) }}"
       class="p-all view-all-index-link">{{__('web/public.view_all_product')}} {{\App\Providers\MyProvider::_text($category->title)}}</a>
</div>