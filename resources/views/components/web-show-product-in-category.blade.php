...
<table class="table table-striped table-responsive-stack " id="tableOne{{$category->id}}">
    ...
    <tr>
        ...
        <th class="th-td-34">{{__('web/public.title')}}</th>
    ...
    @foreach($category->products as $product)
        ...
        <tr>
            ...
            <td class="th-td-34"><a href="{{ route('web.show.product',$product->id) }}" class="title-link-in-list">{{\App\Providers\MyProvider::_text($product->title)}} </a></td>
